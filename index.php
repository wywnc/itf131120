...
?>
  <tr>
    ...
    <td width="150"><div class="text-center"><a href="delete.php?delete_id=<?php echo $Result['ID']; ?>" class="btn btn-danger">Delete</a> 
    <a href="update.php?edit_id=<?php echo $Result["ID"]; ?>" class="btn btn-warning" >Edit</a></div></td>
  </tr>
<?php
}
?>
